    ...
    <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12 mb-16 items-center">
      <div className="lg:col-span-3 text-center lg:text-left">
        ...
        <p className="mt-4 text-lg text-gray-600 max-w-xl mx-auto lg:mx-0">
          An intelligent learning platform with expert-curated quizzes to help
          you master skills and accelerate your career.
        </p>
      </div>
      {featuredQuiz && (
        <div className="lg:col-span-2">
          <div className="bg-white rounded-2xl p-4 border border-gray-200 shadow-xl shadow-blue-500/10 transform transition-transform duration-500 hover:scale-105 group relative">
            ...
            <button
              onClick={() => navigation(`/main/quiz/${featuredQuiz._id}`)}
...
const FilterBar = memo(
  ({ onFilterChange, onSortChange, onLayoutChange, layout, subjects }) => {
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center">
          <div className="relative flex-grow">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-2 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
            />
          </div>
          <div>
            <select
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-4 flex gap-6 items-center hover:shadow-lg hover:border-blue-300 transition-all duration-300 group">
        ...
        <div className="flex-grow">
          ...
          <div className="flex items-center justify-between mt-4">
            ...
            <button
              onClick={() => navigation(`/main/quiz/${quiz._id}`)}
              className="bg-blue-600 cursor-pointer hover:bg-sky-500 text-white font-semibold py-2 px-4 rounded-lg flex items-center gap-2 transform translate-y-2 group-hover:translate-y-0 transition-all duration-300"
            >
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 overflow-hidden group hover:shadow-lg hover:border-blue-300 transition-all duration-300">
      ...
      <div className="p-5">
        ...
        <h3 className="text-lg font-bold text-gray-800 mb-2 truncate group-hover:text-blue-600">
          {quiz.title}
        </h3>
  ...
  const handleFilterChange = useCallback(
    (filters) => {
      ...
      if (filters.searchTerm && filters.searchTerm.trim()) {
        ...
        tempQuizzes = tempQuizzes.filter(
          (q) =>
      ...
      if (filters.subject !== "All") {
        tempQuizzes = tempQuizzes.filter(
          (q) =>
            q.subject?.title === filters.subject || q.topic === filters.subject
        );
      }
