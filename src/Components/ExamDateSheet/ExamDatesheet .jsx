...
const ExamDatesheet = () => {
  ...
  const filteredExams = exams.filter((exam) => {
    ...
    const matchesFilter =
      ...
      (activeFilter === 'In Week' && exam.dayLeft <= 3 && exam.dynamicStatus !== 'completed');
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div variants={itemVariants} className="mb-6 sm:mb-8">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 mb-4">
            ...
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-slate-800">Exam Schedule</h1>
              <p className="text-sm sm:text-base text-slate-600">Stay organized and never miss an exam</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 w-full sm:w-auto">
            <button
              ...
              className={`flex items-center gap-2 px-4 py-3 rounded-2xl font-medium transition-all ${showFilters
        ...
        {/* Stats Cards */}
        <motion.div variants={itemVariants} className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 mb-8">
            ...
            {examsToDisplay.map((exam, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="group relative bg-white/80 backdrop-blur-xl rounded-3xl p-5 sm:p-6 shadow-lg border border-slate-200/50 hover:shadow-2xl transition-all duration-300 cursor-pointer overflow-hidden"
                ...
                >
                  ...
                  <div className="relative z-10 flex items-start justify-between mb-5 sm:mb-6">
                    <div className="flex items-center gap-3 sm:gap-4">
                      <div className={`w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br ${getSubjectColor(exam.subject)} rounded-2xl flex flex-col items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform`}>
                      ...
                      <div>
                        ...
                        <p className="text-xs sm:text-sm text-slate-600">{getDayName(exam.date)}</p>
                  ...
                  <div className="relative z-10 space-y-3 sm:space-y-4">
                    ...
                    <div className="bg-slate-50 rounded-xl p-3 text-sm text-slate-700 min-h-[44px] flex items-center">
