  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Week Day Selector - All 7 days visible like TimeTable */}
        {weekDays.length > 0 && (
          <div className="mb-5">
            <div
              className={`grid gap-2 sm:gap-4 grid-cols-7`} // Fixed to 7 columns like TimeTable
            >
              {weekDays.map((day, index) => (
                <WeekDayCard
                  ...
                  onClick={() => setSelectedDay(day)} // All days clickable like TimeTable
                />
              ))}
            </div>
          </div>
